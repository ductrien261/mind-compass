...
%% --- MDD (Major Depressive Disorder / pure_depression) ---
...
verify_diagnosis(mdd_anxious_distress) :- ask_a1_or_a2, ask_symptom(n1).
...
profile_advice(pure_depression, "MỨC ĐỘ NẶNG (Trầm cảm): Bạn đang đánh mất năng lượng và niềm vui sống. Hãy cố gắng duy trì một thời gian biểu sinh hoạt cố định, giữ kết nối với những người bạn tin tưởng và đi khám tâm lý để được hỗ trợ phương pháp trị liệu phù hợp.").
